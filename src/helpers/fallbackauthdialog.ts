...
const clientId = "8cd034da-354a-48f1-8c11-bfa43a3353ea"; //This is your client ID
...
const msalConfig: Configuration = {
  auth: {
    ...
    redirectUri: "https://nutrient-word-addin-epaddvdkagezbpeg.canadacentral-01.azurewebsites.net/fallbackauthdialog.html", // Update config script to enable `https://${window.location.host}/fallbackauthdialog.html`,

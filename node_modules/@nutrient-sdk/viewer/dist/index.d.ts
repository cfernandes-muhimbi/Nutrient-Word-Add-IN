...
type IFunction<T = void> = (...args: any[]) => T;
...
type Args<T = any> = T extends (...args: infer A) => any ? A : never;
...
type WidgetActionTriggerEventType = Omit<ActionTriggerEventType, 'onPageOpen'> | 'onFocus' | 'onBlur';var WidgetAnnotation$1 = WidgetAnnotation;
...
declare class WidgetAnnotationSerializer extends AnnotationSerializer {
    annotation: WidgetAnnotation$1;
    constructor(annotation: WidgetAnnotation$1);
    toJSON(): WidgetAnnotationJSON;
    static fromJSON(id: ID | null, json: Omit<WidgetAnnotationJSON, 'id' | 'group' | 'permissions'>, options?: ICollaboratorPermissionsOptions): WidgetAnnotation$1;
}
 ...
 */
declare const CommentDisplay: {
    readonly FITTING: "FITTING";
    readonly POPOVER: "POPOVER";
    readonly FLOATING: "FLOATING";
};
type ICommentDisplay = (typeof CommentDisplay)[keyof typeof CommentDisplay];
...
type Session = {
    ...
    getTextBlocks: (pageIndex: number) => Promise<TextBlock$1[]>;
 ...
 * @readonly
 * @memberof NutrientViewer
 * @property {NutrientViewer.DocumentPermissions} annotationsAndForms When set, adding or modifying text annotations
 ...
 * @property {NutrientViewer.DocumentPermissions} assemble When set, it's allowed to assemble the document, that is: insert, rotate, or delete pages, or create bookmarks or thumbnail images.
 * @property {NutrientViewer.DocumentPermissions} extract When set, it's allowed to copy or extract text and graphics from the document.
 * @property {NutrientViewer.DocumentPermissions} extractAccessibility When set, it's allowed to extract text and graphics in support
 * of accessibility to users with disabilities.
 * @property {NutrientViewer.DocumentPermissions} fillForms When set, it's allowed to fill in existing interactive
 * form fields (including Digital Signatures).
 * @property {NutrientViewer.DocumentPermissions} modification When set, it's allowed to modify the contents of the document
 * by operations other than `assemble`.
 * @property {NutrientViewer.DocumentPermissions} printHighQuality When set, it's allowed to print the document
 ...
 * @property {NutrientViewer.DocumentPermissions} printing When set, it's allowed to print the document.
 ...
 * });
 */
type OnWidgetAnnotationCreationStartCallback = (annotation: WidgetAnnotation$1, formField: FormField) => {
    annotation?: WidgetAnnotation$1;
    formField?: FormField;
};
...
/**
 * Nutrient Web SDK comes with a built-in toolbar that shows whenever some text is selected on a document, we will refer to said tooltip as inline toolbar from now on.
 * This callback allows users to customize said inline toolbar.
 * @public
 * @memberof NutrientViewer
 * @callback InlineTextSelectionToolbarItemsCallback
 * @seealso NutrientViewer.Configuration#InlineTextSelectionToolbarItemsCallback
 * @seealso NutrientViewer#Instance.setInlineTextSelectionToolbarItems
...
declare const SearchResult_base: Record$1.Factory<SearchResultProps>;
/**
 * @classdesc
...
declare const SearchState_base: Record$1.Factory<SearchStateProps>;
 ...
 */
type AnnotationPreset$1 = Record<string, unknown>;
...
type BuiltInDocumentEditorToolbarItem = 'add' | 'remove' | 'duplicate' | 'rotate-left' | 'rotate-right' | 'move' | 'move-left' | 'move-right' | 'import-document' | 'extract-pages' | 'spacer' | 'undo' | 'redo' | 'select-all' | 'select-none' | 'zoom-out' | 'zoom-in';
/**
...
declare const allowedToolbarTypes: ("link" | "ellipse" | "image" | "line" | "polygon" | "polyline" | "text" | "spacer" | "search" | "note" | "distance" | "comment" | "zoom-in" | "zoom-out" | "callout" | "arrow" | "highlighter" | "undo" | "redo" | "custom" | "signature" | "ink" | "print" | "document-editor" | "layout-config" | "marquee-zoom" | "responsive-group" | "redact-text-highlighter" | "redact-rectangle" | "cloudy-rectangle" | "dashed-rectangle" | "cloudy-ellipse" | "dashed-ellipse" | "dashed-polygon" | "document-comparison" | "measure" | "form-creator" | "content-editor" | "perimeter" | "rectangle-area" | "ellipse-area" | "polygon-area" | "ai-assistant" | "pager-expanded" | "sidebar-thumbnails" | "sidebar-document-outline" | "sidebar-annotations" | "sidebar-bookmarks" | "sidebar-signatures" | "sidebar-attachments" | "sidebar-layers" | "pager" | "multi-annotations-selection" | "pan" | "zoom-mode" | "linearized-download-indicator" | "annotate" | "text-highlighter" | "ink-eraser" | "stamp" | "rectangle" | "cloudy-polygon" | "document-crop" | "export-pdf" | "debug")[];
 ...
 */
type AnnotationResizeStartCallback = (event: AnnotationsResizeEvent) => AnnotationResizeStartCallbackConfiguration | undefined;
 ...
 * @extends NutrientViewer.ToolItem
 * @seealso NutrientViewer.TextComparisonInstance#setInnerToolbarItems NutrientViewer.TextComparisonConfiguration#instanceToolbarItems
 */
/**
 * ***required***
 *
 ...
 * @public
 * @instance
 * @member {?NutrientViewer.TextComparisonInnerToolbarItem.OnPressCallback} onPress
 * @memberof NutrientViewer.TextComparisonInnerToolbarItem
 */
/**
 * @public
 ...
 * @extends NutrientViewer.ToolItem
 * @seealso NutrientViewer.TextComparisonInstance#setToolbarItems NutrientViewer.TextComparisonConfiguration#toolbarItems
 */
/**
 * ***required***
 *
 ...
 * @public
 * @instance
 * @member {?NutrientViewer.TextComparisonToolbarItem.OnPressCallback} onPress
 * @memberof NutrientViewer.TextComparisonToolbarItem
 */
/**
 * @public
...
declare const textComparisonActionCreators: {
    ...
    setToolbarItems: (payload: List<ToolbarItem>) => {
        type: "SET_TOOLBAR_ITEMS";
        payload: List<ToolbarItem$1>;
    };
 ...
 * @public
 */
interface AIEnhancedTextComparisonChange extends TextComparisonChange {
    aiId?: string;
    categories?: string[];
    aiProcessed?: boolean;
}
...
/**
 * Response item from AI services
 * @public
 */
...
/**
 * Response item with tags from tagging service
 * @public
 */
interface AIADocumentChangeTaggingItem extends AIADocumentChangeResponseItem {
    tag: string[];
}
/**
...
/**
 * Type alias for AI document comparison result
 * @public
 */
type AIDocumentComparisonResult = AIADocumentChangesAnalysisResponse | AIADocumentChangesTaggingResponse;
 ...
 */
interface IComparisonOperationOptions {
    [key: string]: any;
}
interface ITextComparisonOperationOptions extends IComparisonOperationOptions {
    numberOfContextWords?: number;
    wordLevel?: boolean;
}
interface IAIComparisonOperationOptions extends IComparisonOperationOptions {
...
type IAIComparisonOperationType = (typeof AIComparisonOperationType)[keyof typeof AIComparisonOperationType];
...
declare class Instance {
    ...
    annotationCreatorName: string | null;
    ...
    getTextSelection: () => PublicTextSelection | null | undefined;
    ...
    compareDocuments: (comparisonDocuments: ComparisonDocuments, operations: ComparisonOperation) => Promise<DocumentComparisonResult | AIDocumentComparisonResult>;
 ...
 * @public
 * @callback ContentEditingFontMatcher
 ...
 * @memberof NutrientViewer
 */
type ContentEditingFontMatcher = (match: string, fontInfo: FontInfo, availableFonts: AvailableFontFace[]) => FontMatchResult | undefined;

declare const FaceVariant_base: Record$1.Factory<{
    bold: boolean;
    italic: boolean;
}>;
declare class FaceVariant extends FaceVariant_base {
}
declare const AvailableFace_base: Record$1.Factory<{
    family: string;
    variants: Set$1<FaceVariant>;
}>;
...
type IAnonymousCommentMode = boolean | (typeof AnonymousCommentMode)[keyof typeof AnonymousCommentMode];
...
type ServerAuthPayloadConfiguration = {
    /**
...
type ServerSessionAuthConfiguration = {
    /**
     * ***Server only***
     *
...
/**
 * Indicates the type of modification made to a {@link NutrientViewer.Change}.
 * @public
 * @typedef {'CREATED'|'UPDATED'|'DELETED'} NutrientViewer.ModificationType
 */
 ...
 * @instance
 * @memberof NutrientViewer.SaveError
 * @typedef {object} NutrientViewer.SaveError~ErrorReason
...
type ToolbarItem = ToolbarItem$1;
...
type AnnotationAdditionalActionsType = {
...
declare function serializeAnnotation(annotation: WidgetAnnotation$1): AnnotationBackendJSON<WidgetAnnotationJSON>;
...
declare const NutrientViewer: {
    ...
    Annotations: {
        ...
        WidgetAnnotation: typeof WidgetAnnotation$1;
...
export { Action, Annotation, AnnotationsWillChangeReason, Bookmark, ButtonFormField, CheckBoxFormField, ChoiceFormField, Color, ComboBoxFormField, Comment, CommentDisplay, CommentMarkerAnnotation, Conformance, CustomOverlayItem, DrawingPoint, EllipseAnnotation, Font, FormField, FormFieldValue, FormOption, GoToAction, GoToEmbeddedAction, GoToRemoteAction, HideAction, HighlightAnnotation, HighlightState, ImageAnnotation, InkAnnotation, Inset, Instance, InstantClient, JavaScriptAction, LaunchAction, LineAnnotation, LinkAnnotation, List, ListBoxFormField, NamedAction, NoteAnnotation, OutlineElement, PageInfo, Point, PolygonAnnotation, PolylineAnnotation, RadioButtonFormField, Rect, RectangleAnnotation, RedactionAnnotation, ResetFormAction, SearchResult, SearchState, Set$1 as Set, ShapeAnnotation, SignatureFormField, Size, SquiggleAnnotation, StampAnnotation, StrikeOutAnnotation, SubmitFormAction, TextAnnotation, _default as TextComparisonConfiguration, TextComparisonInstance, TextFormField, TextLine, TextMarkupAnnotation, PublicTextSelection as TextSelection, URIAction, UnderlineAnnotation, UnknownAnnotation, ViewState, WidgetAnnotation$1 as WidgetAnnotation, NutrientViewer as default };
export type { AnnotationJSONUnion, AnnotationToolbarItem, AnnotationsUnion, BuildInput, BuildInstructions, Configuration, ContentEditing, DocumentEditorFooterItem, DocumentEditorToolbarItem, EllipseAnnotationJSON, ImageAnnotationJSON, InkAnnotationJSON, _Interfaces as Interfaces, LineAnnotationJSON, MentionableUser, NoteAnnotationJSON, OfficeConversionSettings, PolygonAnnotationJSON, PolylineAnnotationJSON, ProcessingAuthPayload, RectangleAnnotationJSON, RedactionAnnotationJSON, ServerConfiguration, ShapeAnnotationsUnion, StampAnnotationJSON, StandaloneConfiguration, TemplateDataToPopulateDocument, TextAnnotationJSON, TextMarkupAnnotationJSON, TextMarkupAnnotationsUnion, ToolbarItem$1 as ToolbarItem, UnknownAnnotationJSON, WidgetAnnotationJSON };

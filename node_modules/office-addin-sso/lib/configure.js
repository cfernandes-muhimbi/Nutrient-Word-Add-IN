...
function createNewApplication(ssoAppName, port, userJson /* eslint-disable-line @typescript-eslint/no-unused-vars */) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let azRestCommand = yield fs_1.default.readFileSync(defaults.azRestAppCreateCommandPath, "utf8");
                ...
                case "win32": {
                    ...
                    cliInstalled = appsWindows.filter((app) => {
                        if (app !== null && app.DisplayName && typeof app.DisplayName === "string") {
                            if (app.DisplayName.includes("Microsoft Azure CLI"))
                                return true;
                        }
                        return false;
                    });
...
function isUserTenantAdmin(userInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let azRestCommand = fs_1.default.readFileSync(defaults.azRestGetTenantRolesPath, "utf8");
            ...
            azRestCommand = fs_1.default.readFileSync(defaults.azRestGetTenantAdminMembershipCommandPath, "utf8");
...
function logoutAzure() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield promiseExecuteCommand("az logout", true /* returnJson */, true /* expectError */);
    });
}
...
function promiseExecuteCommand(cmd, returnJson = true, expectError = false) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            try {
                child_process_1.default.exec(cmd, { maxBuffer: 1024 * 102400 }, (err, stdout, stderr) => __awaiter(this, void 0, void 0, function* () {
                    if (err && !expectError) {
                        reject(stderr);
                    }
                    let results = stdout;
...
function setApplicationSecret(applicationJson, secretTTL) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let azRestCommand = yield fs_1.default.readFileSync(defaults.azRestAddSecretCommandPath, "utf8");
            let now = new Date();
...
function setIdentifierUri(applicationJson, port) {
    return __awaiter(this, void 0, void 0, function* () {
        let azRestCommand = yield fs_1.default.readFileSync(defaults.azRestSetIdentifierUriCommmandPath, "utf8");
...
function setSignInAudience(applicationJson) {
    return __awaiter(this, void 0, void 0, function* () {
        let azRestCommand = fs_1.default.readFileSync(defaults.azRestSetSigninAudienceCommandPath, "utf8");
        azRestCommand = azRestCommand.replace("<App_Object_ID>", applicationJson["id"]);
...
function setSharePointTenantReplyUrls(tenantName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let azRestCommand = fs_1.default.readFileSync(defaults.azRestGetOrganizationDetailsCommandPath, "utf8");
            ...
            if (setReplyUrls && servicePrinicipalObjectlId) {
                azRestCommand = fs_1.default.readFileSync(defaults.azRestAddTenantReplyUrlsCommandPath, "utf8");
...
function setOutlookTenantReplyUrl() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (setReplyUrls && servicePrinicipalObjectlId) {
                azRestCommand = fs_1.default.readFileSync(defaults.azRestAddTenantOutlookReplyUrlsCommandPath, "utf8");
